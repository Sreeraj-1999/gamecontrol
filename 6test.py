...
def checkLeftRight(image, results, draw=False, display=False):
    ...
    if draw:
        ...
        cv2.putText(output_image, horizontal_position, (5, text_y), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 3)

        center_line_y = height // 2 
        
        # Draw a line at the center of the image.
        cv2.line(output_image, (width//2, center_line_y), (width//2, height), (255, 255, 255), 2)
...
def checkJumpCrouch(image, results, MID_Y=250, draw=False, display=False):
    ...
    # Write the horizontal position of the person on the image.
        ...
        cv2.putText(output_image, posture, (text_x, text_y), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 3)

    # Draw a line at the center of the image.
        center_line_x = width // 2  # Center horizontally
        center_line_y = height // 2  # Center vertically
        cv2.line(output_image, (center_line_x, 0), (center_line_x, height), (255, 255, 255), 2)
        cv2.line(output_image, (0, center_line_y), (width, center_line_y), (255, 255, 255), 2)
